...
namespace MySql.Data.MySqlClient {
    ...
    public class MySqlDbContext : DbContext {
        ...
        protected MySqlDbContext( string nameOrConnectionString ) : base( nameOrConnectionString ) {
            this.ConnectionString = nameOrConnectionString;
            Database.DefaultConnectionFactory = new MySqlConnectionFactory( this.ConnectionString );
        }
        ...
        protected MySqlDbContext( string database, string userId, string password, string server = "localhost", uint port = 3306 )
