...
namespace MySql.Data.MySqlClient {
    ...
    ///     http://msdn.microsoft.com/en-us/library/dd799517(v=vs.103).aspx.
    /// </typeparam>
...
VALUES (
    ...
    @ProductVersion);
";
                    command.Parameters.AddWithValue( "@Model", this.GetModel( context ) );
                    command.Parameters.AddWithValue( "@ProductVersion", this.GetProductVersion() );
        ...
        private string GetProductVersion() {
            return
                typeof( DbContext ).Assembly.GetCustomAttributes( false )
