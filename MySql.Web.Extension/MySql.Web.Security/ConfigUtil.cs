...
namespace MySql.Web.Security {
    internal static class ConfigUtil {
        ...
        internal static bool ShouldPreserveLoginUrl() {
            var settingValue = ConfigurationManager.AppSettings[ FormsAuthenticationSettings.PreserveLoginUrlKey ];
            bool preserveLoginUrl;
            if ( !String.IsNullOrEmpty( settingValue ) && Boolean.TryParse( settingValue, out preserveLoginUrl ) ) return preserveLoginUrl;
        ...
        private static bool IsMySqlSimpleMembershipEnabled() {
            ...
            bool enabled;
            if ( !String.IsNullOrEmpty( settingValue ) && Boolean.TryParse( settingValue, out enabled ) ) return enabled;
